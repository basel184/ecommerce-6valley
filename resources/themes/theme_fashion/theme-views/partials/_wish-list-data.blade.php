                ...
                @if( $wishlist->productFullInfo)
                    <tr class="row_id{{$product->id}} product-cart-option-container">
                        <form class="cart addToCartDynamicForm add_to_cart_form" action="{{ route('cart.add') }}"
                              id="stock_check_for_product_mobile{{$product->id}}"
                                    ...
                                    <div class="cont">
                                        ...
                                        @if ($product->product_type == "physical")
                                            ...
                                            <div class="d-flex column-gap-1">
                                                <span class="w-50px">{{ translate('price') }}</span> <span>:</span> <strong
                                            ...
                                            <div class="d-flex column-gap-1">
                                                <span class="w-50px">{{ translate('vat') }}</span> <span>:</span> <strong
                                        ...
                                        <div class="d-flex column-gap-1">
                                            @if (isset($product->category))
                                                <span class="w-50px">{{ translate('category') }} </span> <span>:</span>
                                                    ...
                                                    <div class="d-flex column-gap-1">
                                                        ...
                                                        <select class="no-border-select text-title variants-class{{$key}} stock_check_for_product_web"
                                                            ...
                                                            @foreach (json_decode($product->colors) as $k=>$value)
                                                                <option value="{{ $value }}">{{ getColorNameByCode(code: $value) }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                @endif
                            ...
                            <td class="text-center text-base total_price{{$product->id}}">
                        ...
                        <div class="cart-product">
                            ...
                            <div class="cont d-flex flex-column gap-1">
                                ...
                                <div class="d-flex flex-wrap">
                                    <span class="w-50px">{{ translate('discount') }}</span> <span>:</span>
