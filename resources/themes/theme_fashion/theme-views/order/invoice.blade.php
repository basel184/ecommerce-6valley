            ...
            <tr>
                ...
                <td class="text-right" style="padding:23px 16px">
                    ...
                    <div class="fz-16 text-primary text-right">
                        {{ finalSaudiPrice($orderTotalPriceSummary['totalAmount']) }}
                    </div>
                </td>
            </tr>
            <tr>
        ...
        @else
            <tr>
                ...
                <td class="text-right border-bottom" style="padding:23px 16px">
                    ...
                    <div class="fz-16 text-primary text-right">{{ finalSaudiPrice($orderTotalPriceSummary['totalAmount']) }}</div>
                </td>
            </tr>
        @endif
        <tr>
            <td class="customers bs-0" colspan="5" style="padding: 10px; width: 100%; border-collapse: collapse">
                    ...
                    @foreach($order->details as $key=>$details)
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="fs-10 text-dark">{{ finalSaudiPrice($details['price']) }}</div>
                            </td>
                            <td class="text-right">
                                <div class="fs-10 text-dark">
                                    {{ finalSaudiPrice($details['price'] * $details['qty']) }}
                                </div>
                            </td>
                        </tr>
                            <?php
