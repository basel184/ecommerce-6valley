                            ...
                            <div class="col-xl-6 col-md-6">
                                <label
                                    ...
                                    <span>
                                        ...
                                        <p class="mb-0 fs-12">
                                            {{ translate('if_enabled_this_option_customers_will_be_able_to_enter_their_billing_address_information') }}
                                        </p>
                                    </span>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6 d-none">
                                <div class="form-group">
                                    ...
                                    <div
                                        class="min-h-40 d-flex align-items-sm-center flex-column flex-sm-row gap-sm-4 border rounded mb-2 px-3 py-1 bg-white" id="free-delivery-responsibility"
